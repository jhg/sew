...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Articulo.url'
        db.delete_column('blogs_articulo', 'url')


    def backwards(self, orm):
        # Adding field 'Articulo.url'
        db.add_column('blogs_articulo', 'url',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=512, unique=True),
                      keep_default=False)
