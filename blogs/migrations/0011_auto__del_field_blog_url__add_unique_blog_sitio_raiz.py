...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('blogs_blog', 'url')

        # Adding unique constraint on 'Blog', fields ['sitio_raiz']
        db.create_unique('blogs_blog', ['sitio_raiz'])


    def backwards(self, orm):
        # Removing unique constraint on 'Blog', fields ['sitio_raiz']
        db.delete_unique('blogs_blog', ['sitio_raiz'])

        # Adding field 'Blog.url'
        db.add_column('blogs_blog', 'url',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=64, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'publicado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sitio_raiz': ('django.db.models.fields.IntegerField', [], {'default': '0', 'unique': 'True'}),
