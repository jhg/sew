...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sitios on 'Blog'
        db.create_table('blogs_blog_sitios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['blogs.blog'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('blogs_blog_sitios', ['blog_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sitios on 'Blog'
        db.delete_table('blogs_blog_sitios')
