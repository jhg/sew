...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.suburl'
        db.add_column('blogs_blog', 'suburl',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Blog.suburl'
        db.delete_column('blogs_blog', 'suburl')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'autores': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            'descripcion': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'suburl': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '42'}),
