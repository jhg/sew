...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Articulo', fields ['url']
        db.create_unique('blogs_articulo', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'Articulo', fields ['url']
        db.delete_unique('blogs_articulo', ['url'])
