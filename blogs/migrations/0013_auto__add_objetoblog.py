...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObjetoBlog'
        db.create_table('blogs_objetoblog', (
            ...
            ('codigo_servidor', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('codigo', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('blogs', ['ObjetoBlog'])


    def backwards(self, orm):
        # Deleting model 'ObjetoBlog'
        db.delete_table('blogs_objetoblog')
    ...
    models = {
        ...
        'blogs.objetoblog': {
            'Meta': {'object_name': 'ObjetoBlog'},
            'codigo': ('django.db.models.fields.TextField', [], {}),
            'codigo_servidor': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'creado': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modificado': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
